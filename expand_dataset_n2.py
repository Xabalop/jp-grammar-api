# expand_dataset_n2.py
import pandas as pd

SRC = "grammar_n2.csv"
DST = "expanded_grammar_n2.csv"
MAX_PER_BASE = 20

TIME_PREFIXES_JP = ["しばしば", "ときに", "普段は", "たまに", "一般的に"]
TIME_PREFIXES_ES = ["Con frecuencia", "En ocasiones", "Normalmente", "A veces", "En general"]
