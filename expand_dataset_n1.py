# expand_dataset_n1.py
import pandas as pd

SRC = "grammar_n1.csv"
DST = "expanded_grammar_n1.csv"
MAX_PER_BASE = 20

TIME_PREFIXES_JP = ["しばしば", "往々にして", "概して", "一般的に", "時には"]
TIME_PREFIXES_ES = ["Con frecuencia", "A menudo", "En términos generales", "En general", "En ocasiones"]
